...
#Region "Metodos y funciones indispensables"
    ...
    Private Sub P_prEliminarRegistro()
        ...
        _CVal = L_Validartabla("ZY002", tbNumi.Text, _Nombre)
        If _CVal > 0 Then
            ToastNotification.Show(Me, "ROL esta siendo usado por ".ToUpper + _CVal.ToString + " " + _Nombre.ToUpper + ". Eliminacion Rechazada.".ToUpper,

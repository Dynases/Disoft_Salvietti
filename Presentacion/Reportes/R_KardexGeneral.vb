...
Public Class R_KardexGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_KardexGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_KardexGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_KardexGeneral = New R_KardexGeneral()
        rpt.Site = Me.Site
        Return rpt
    End Function

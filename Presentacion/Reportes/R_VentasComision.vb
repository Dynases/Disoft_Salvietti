...
Public Class R_VentasComision
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_VentasComision.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VentasComision
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VentasComision = New R_VentasComision()
        rpt.Site = Me.Site
        Return rpt
    End Function

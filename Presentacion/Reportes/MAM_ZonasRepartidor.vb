...
Public Class MAM_ZonasRepartidor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MAM_ZonasRepartidor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.MAM_ZonasRepartidor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Titulo02() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedMAM_ZonasRepartidor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MAM_ZonasRepartidor = New MAM_ZonasRepartidor()
        rpt.Site = Me.Site
        Return rpt
    End Function
